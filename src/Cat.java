...
public class Cat {
	...
	private static final int MOUTH_HEIGHT = 5; //changed mouth height
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		int y=catY;
		// Draw the head
		g2.setColor(Color.orange); //changed head color
		g2.fillOval(x, y, HEAD_DIMENSION, HEAD_DIMENSION);
		// Draw the eyes
		g2.setColor(Color.black);//changed eye color to red
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		...
		g2.drawString("Mondays are great", catX, catY+HEAD_DIMENSION+10); //changed what is said/displayed	
	}
}
